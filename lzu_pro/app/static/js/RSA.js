...
function myfunc(password) {
    setMaxDigits(19);
    var random_p2="16d1507964604313b5121c52c1051115";
   var bigN="70a6c76c3631387e7eaca739f7f5cbe7"
   // key_public = new RSAKeyPair(random_p1,"",bigN);
   key_private = new RSAKeyPair("",random_p2,bigN);
    // var password = "1231231231";
 // var password1 = encryptedString(key_public,password);
 var password2 = decryptedString(key_private,password);
 return password2
